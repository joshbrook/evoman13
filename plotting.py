...
level = 1  # input("Which level to plot: ")
runs = 5
...
gens = np.arange(1, 102, 1)
plt.fill_between(gens, std_own_ea_plus, std_own_ea_minus, alpha=0.3)
plt.fill_between(gens, std_cma_plus, std_cma_minus, alpha=0.3)
...
plt.title("Fitness vs. Generation, Level " + str(level))
plt.savefig("plots/plotv2_level" + str(level) + ".png")
plt.show()
